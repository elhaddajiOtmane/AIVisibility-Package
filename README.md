...
| Document | Path |
|----------|------|
| Business Plan | `03-ai-surfaced/docs/AIVISIBILITY_COMPLETE_BUSINESS.md` |
| Validation Research | `03-ai-surfaced/docs/AIVISIBILITY-VALIDATION.md` |
| Launch Playbook | `03-ai-surfaced/marketing/AIVISIBILITY-LAUNCH-PLAYBOOK.md` |
| Email Sequences | `03-ai-surfaced/marketing/AIVISIBILITY-EMAIL-SEQUENCES.md` |
| Build Order Guide | `03-ai-surfaced/docs/BUSINESS-CREATION-ORDER.md` |
